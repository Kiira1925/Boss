...
#define ABS_SECOND_BATTLE_LINE			(7860)
#define ABS_THIRD_BATTLE_LINE			(13620)
#define ABS_FIRST_BATTLE_PLAYER_POS		(2349)
#define ABS_SECOND_BATTLE_PLAYER_POS	(8049)
#define ABS_THIRD_BATTLE_PLAYER_POS		(13809)
#define GATE_HEIGHT						(1080)
...
struct MapData
{
	...
	int second_battle_line;
	int third_battle_line;
};
